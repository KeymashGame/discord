  ...
  return new Promise((resolve, reject) => {
    ...
    switch (option.toLowerCase()) {
      case "discord":
        ...
        const discordQueryString = decodeURI(
          new URLSearchParams(paramsDiscord)
        );
        console.log(
          `GET ${endpoint}/player/${type}?${discordQueryString}`.yellow
        );
      ...
      default:
        ...
        const defaultQueryString = decodeURI(
          new URLSearchParams(paramsDefault)
        );
        console.log(
          `GET ${endpoint}/player/${type}?${defaultQueryString}`.yellow
        );
